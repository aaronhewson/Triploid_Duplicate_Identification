...
# Prior to using this script, Howard et al. 2023 data downloaded as a .xlsx file was formatted in Excel to match PLINK style. Triploid genotype calls were replaced with biallelic genotype calls.
...
# Combine JD/PFR and Howard Samples ------------------------------------------
